...
S26 AI guidance: this scenario has THREE headline deliverables that the UI promises and you MUST emit:
  (a) "Emergency Map" — the 4-stage response_plan with at least 2 concrete actions per stage and a target_duration on each stage. Stage 4 (Prevent) MUST contain at least 2 recurrence_prevention_checklist items AND at least 1 process_change — never leave Stage 4 empty.
