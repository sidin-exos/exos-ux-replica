...
function buildDocStyles(c: DocColors) {
  return StyleSheet.create({
    ...
    analysisTextHighlight: { fontSize: 12, color: c.primary, lineHeight: 1.6, marginBottom: 8, fontWeight: 700, fontFamily: "Helvetica-Bold", backgroundColor: c.primary + "15", paddingHorizontal: 6, paddingVertical: 3, borderRadius: 3 },
