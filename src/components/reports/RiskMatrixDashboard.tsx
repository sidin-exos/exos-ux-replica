                ...
                .map((r) => {
                  ...
                  return (
                    <li
                      ...
                      onMouseEnter={() => setHoveredId(r.id)}
                      onMouseLeave={() => setHoveredId(null)}
                      className={`flex items-center gap-3 p-2 pl-3 rounded-md border-l-[3px] ${accent.border} bg-muted/40 cursor-pointer transition-colors ${
                        isHovered ? "bg-muted" : "hover:bg-muted/60"
                      }`}
                    >
                      <div className="flex flex-col items-center justify-center w-8 flex-shrink-0">
                        <span className={`text-lg font-bold leading-none ${accent.text}`}>
                          {r.score}
                        </span>
                      ...
                      <span
                        className={`text-[9px] font-semibold px-2 py-0.5 rounded-full whitespace-nowrap ${action.className}`}
                      >
                        {action.label}
                      </span>
                    </li>
