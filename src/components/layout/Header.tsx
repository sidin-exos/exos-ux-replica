    ...
    <header className="sticky top-0 z-50 glass-effect border-b border-border/50">
      <div className="container flex h-16 items-center justify-between">
        <NavLink to="/" className="flex items-center gap-3 hover:opacity-90 transition-opacity">
          <div className="flex items-center justify-center w-20 h-20 -my-2 rounded-xl overflow-hidden ring-2 ring-primary/40 shadow-lg shadow-primary/20 bg-background/80">
            <img src={exosLogo} alt="EXOS Logo" className="w-32 h-32 object-contain scale-[2]" />
          </div>
          <div>
