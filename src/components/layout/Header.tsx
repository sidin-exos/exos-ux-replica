    ...
    <header className="sticky top-0 z-50 glass-effect border-b border-border/50">
      <div className="container flex h-16 items-center justify-between">
        ...
        <NavLink to="/welcome" className="flex items-center hover:opacity-90 transition-opacity">
          <img src={exosLogo} <img src={exosLogo} alt="EXOS procurement platform logo" className="h-10 md:h-12 w-auto object-contain" /> className="h-10 md:h-12 w-auto object-contain" />
        </NavLink>
