...
export const SCENARIO_EVAL_CONFIGS: Record<string, ScenarioEvalConfig> = {
  ...
  "spend-analysis-categorization": {
    ...
    blocks: [
      { fieldId: "industryContext", label: "Industry & Business Context", minWords: 20, expectedDataType: "narrative", required: true },
      { fieldId: "rawSpendData", label: "Spend Data", minWords: 30, expectedDataType: "tabular", required: true },
      { fieldId: "classificationParameters", label: "Classification Parameters", minWords: 15, expectedDataType: "mixed", required: false },
    ],
    scenarioChecks: [],
  ...
  "specification-optimizer": {
    ...
    blocks: [
      { fieldId: "industryContext", label: "Industry & Business Context", minWords: 20, expectedDataType: "narrative", required: true },
      { fieldId: "specificationText", label: "Current Specification", minWords: 30, expectedDataType: "narrative", required: true, expectedKeywords: ["material", "tolerance", "standard", "grade"] },
      { fieldId: "specContext", label: "Challenge Parameters", minWords: 15, expectedDataType: "mixed", required: false },
    ],
    scenarioChecks: [],
  ...
  "supplier-review": {
    ...
    blocks: [
      { fieldId: "industryContext", label: "Industry & Business Context", minWords: 20, expectedDataType: "narrative", required: true },
      { fieldId: "performanceMetrics", label: "Performance Metrics", minWords: 30, expectedDataType: "numeric", required: true, expectedKeywords: ["delivery", "quality", "reject", "invoice", "satisfaction"] },
      { fieldId: "qualitativeAssessment", label: "Qualitative Assessment", minWords: 20, expectedDataType: "narrative", required: false },
    ],
    scenarioChecks: [],
