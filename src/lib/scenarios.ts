...
export const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    requiredFields: [
      ...
      { id: "catalogAvailable", label: "Available in Catalog", description: "Is this item in your approved catalog?", type: "select", required: false, options: ["Yes", "No"] },
      { id: "quotesCount", label: "Number of Quotes", description: "How many quotes do you have?", type: "number", required: false },
      { id: "paymentTerms", label: "Payment Terms", description: "Preferred payment method", type: "select", required: false, options: ["Corporate Card", "Invoice", "Purchase Order"] },
      ...
      { id: "approvalRequired", label: "Manager Approval Required", description: "Does this need management sign-off?", type: "select", required: false, options: ["Yes", "No"] },
    ],
