...
export const scenarios: Scenario[] = [
  ...
  // ===== 1. TCO ANALYSIS — TYPE 1 =====
  {
    ...
    outputs: [
      ...
      "Decision Recommendation: Chatbot-powered buy/lease/defer guidance",
    ],
    scenario_id: "S1",
    group: "A",
  },
  ...
  // ===== 2. COST BREAKDOWN — TYPE 1 =====
  {
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Product Specification & BOM Structure", description: "Provide a summary of the product/service specification and Bill of Materials with material families. Without material and labour splits, the Chatbots produces a high-level estimate that suppliers will credibly rebut." },
        ...
        { heading: "Comparative Supplier Quotes", description: "Collect at least 2 supplier quotes to enable competitive benchmarking. Without comparatives, the Chatbots cannot identify inflated margins or anchor negotiation positions." },
  ...
  // ===== 6. FORECASTING & BUDGETING — TYPE 1 =====
  {
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Category Spend History (2+ Years)", description: "Provide category spend history (minimum 2 years), key volume drivers, and planning horizon (1 or 3 year). Without trend data, the Chatbots produces flat-line forecasts that ignore inflation and volume shifts." },
  ...
  // ===== 7. SAAS OPTIMIZATION — TYPE 1 =====
  {
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Active SaaS Tools & Licence Counts", description: "List all active SaaS tools, licence count per tool, approximate annual contract value, and renewal dates. Without this baseline, the Chatbots cannot identify unused licences or missed cancellation windows." },
  ...
  // ===== 8. SPECIFICATION OPTIMIZER — TYPE 0 =====
  {
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Technical Specification & Tolerances", description: "Provide a summary of the specification or technical requirements, performance tolerances required, and material/grade currently specified. Without the spec summary, the Chatbots cannot identify where over-specification exists." },
  ...
  // ===== 9. RFP GENERATOR — TYPE 0 =====
  {
    ...
    previewDescription: "Drop in your raw procurement brief — however rough — and the Chatbots extracts key requirements, generates a structured tender package (RFP, RFI, or RFQ), builds an evaluation matrix with weighted scoring, and flags missing information that could delay the process. Eliminates 3–6 weeks of tender preparation work and prevents the #1 cause of RFP reissue: incomplete evaluation criteria.",
  ...
  // ===== 11. TAIL SPEND — TYPE 0 =====
  {
    ...
    dataRequirements: {
      ...
      sections: [
        ...
        { heading: "Quality & Specification Standards", description: "Include quality standards, preferred supplier types (local, certified, diverse), and budget ceiling. Without these, the Chatbots cannot assess compliance against your procurement policy." },
  ...
  // ===== 12. CONTRACT TEMPLATE — TYPE 0 =====
  {
    ...
    previewDescription: "Generate jurisdiction-aware contract templates tailored to EU procurement law. Select your time-investment tier (Quick/Standard/Comprehensive) and the Chatbots produces structured clause sets covering scope, pricing, liability, IP, termination, and GDPR compliance — with clause-by-clause guidance explaining what each provision protects against. A professional starting point, not legal advice, that saves days of drafting time.",
    icon: ScrollText,
    status: "available",
    category: "documentation",
    deviationType: 0,
  ...
  // ===== 16. SOW CRITIC — TYPE 2 =====
  {
    id: "sow-critic",
    title: "SOW Critic",
    description: "Chatbot-powered Statement of Work review to identify gaps, ambiguities, and protection issues.",
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Complete SOW Text & Engagement Type", description: "Paste or upload the full draft SOW text and specify the engagement type (fixed-price, T&M, milestone-based). The Chatbots cannot identify gaps it cannot see — an incomplete SOW provided for review will receive an incomplete review." },
  ...
  // ===== 18. RISK MATRIX — TYPE 1H =====
  {
    ...
    previewDescription: "Build a visual risk heatmap from structured risk inputs. Provide at least 5 identified risks with probability and impact ratings, and the Chatbots generates a colour-coded matrix with mitigation priorities, owner assignments, and residual risk targets. Transforms a static spreadsheet into a living risk management tool with escalation thresholds and board notification triggers.",
    icon: Shield,
    status: "available",
    category: "risk",
    strategySelector: "costVsRisk",
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Risk List with Probability & Impact", description: "Provide a minimum of 5 identified risks with estimated probability (High/Medium/Low) and impact (High/Medium/Low) for each. Without these, the Chatbots defaults to generic ratings that provide no actionable prioritisation." },
  ...
  // ===== 19. SOFTWARE LICENSING — TYPE 2 =====
  {
    ...
    outputs: [
      ...
      "Risk-adjusted Recommendation: Chatbot-powered optimal licensing strategy",
    ],
    scenario_id: "S19",
    group: "C",
  },
  ...
  // ===== 22. CATEGORY STRATEGY — TYPE 0 =====
  {
    ...
    description: "Comprehensive category management analysis with Chatbot-guided insights, best practices from proprietary database, and cross-category analogies.",
  ...
  // ===== 23. MAKE VS BUY — TYPE 1H =====
  {
    ...
    dataRequirements: {
      ...
      sections: [
        { heading: "Internal Cost Benchmarks", description: "Gather fully-loaded costs for in-house production: labor, overhead, equipment depreciation, and opportunity cost. Without these, the Chatbots cannot detect hidden cost advantages or flag underestimated internal expenses." },
        { heading: "External Quotes & Market Data", description: "Collect at least 2–3 vendor quotes including unit price, MOQ, lead time, and payment terms. Market benchmarks let the Chatbots identify whether quotes are competitive or inflated." },
  ...
  // ===== 26. DISRUPTION MANAGEMENT — TYPE 0 =====
  {
    ...
    previewDescription: "Activate a structured crisis response when disruption hits. Describe the event and the Chatbots generates a 4-stage recovery algorithm, models financial impact under different delay scenarios, identifies pre-qualified alternative suppliers, and drafts stakeholder communications. Reactive disruption management costs 2.3x more and lasts 40–60% longer than structured responses — this scenario provides the structure in minutes.",
    icon: AlertTriangle,
    status: "available",
    category: "risk",
    strategySelector: "speedVsQuality",
