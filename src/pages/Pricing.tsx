      ...
      <main className="container py-8 relative">
        ...
        <section className="mb-12 text-center animate-fade-up">
          <div className="flex justify-center mb-6">
            <img src={exosLogo} <img src={exosLogo} alt="EXOS procurement platform logo" className="h-16 md:h-20 w-auto object-contain" /> className="h-16 md:h-20 w-auto object-contain" />
          </div>
