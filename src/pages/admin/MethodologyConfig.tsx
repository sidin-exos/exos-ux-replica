      ...
      <main className="container max-w-6xl py-12 space-y-8">
        <Breadcrumb>
          <BreadcrumbList className="text-[13px] text-slate-400">
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-slate-600">Global Configuration</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>

        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Global Configuration</h1>
        ...
        <div className="space-y-6">
          {configs?.map((config) => {
            ...
            return (
              <Card key={config.key} className="bg-white border border-slate-200 rounded-lg shadow-none">
                ...
                <CardContent className="space-y-4">
                  <Textarea
                    rows={14}
                    className="font-mono text-sm bg-white border-slate-200 rounded-md focus-visible:ring-teal-600"
