      ...
      <main className="container py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="hidden lg:flex items-center justify-center">
            <img src={signalRadarImg} alt="Signal radar illustration" loading="lazy" width={256} height={128} className="w-64 h-auto object-contain opacity-80 mix-blend-multiply dark:mix-blend-screen" />
          </div>
        </div>
